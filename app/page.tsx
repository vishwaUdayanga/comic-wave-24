    ...
    <>
      <main className="flex flex-col items-center bg-cover bg-center mt-0 overflow-hidden z-10" style={{backgroundImage : "url('/main/main-bg.png')"}}>
        <Image 
          ...
          width={250}
          height={250}
          className="mt-5 bg-cover bg-center"
        />
        ...
        <Link href={'/tickets/ticket_regular'} className="pl-16 pr-16 pb-3 pt-3 custom-purple-low text-xs rounded mt-5 text-center">Buy Tickets Right Now</Link>
        <Image 
