...
export default function Sponsors() {
    return (
        <>
            <section className="flex pt-10 pr-4 pl-4 pb-10 justify-center items-center custom-dark-high flex-col">
                <div className="flex w-full justify-center md:w-2/4 flex-col items-center">
                    <h1 className="text-3xl font-bold mt-5 z-10 text-center">Partners and <span className="text-violet-600">Sponsors</span></h1>
