...
import VerifyStudentTable from '@/app/ui/admin/verify-student-table';
...
export default async function Page({
    ...
    const totalPages = await fetchStudents(query);

    return (
        <div className="min-h-screen flex w-full flex-col">
            <h1 className="text-4xl text-indigo-500 font-bold mt-6 text-center">Verify students</h1>
          <div className="mt-4 flex items-center justify-between gap-2 md:mt-8">
            <Search placeholder="Search invoices..." />
          </div>
          <VerifyStudentTable query={query} currentPage={currentPage} />
