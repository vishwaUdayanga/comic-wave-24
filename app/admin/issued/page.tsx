...
import IssuedTable from '@/app/ui/admin/issued-table';
import { fetchIssued } from '@/app/lib/actions';
...
export default async function Page({
    ...
    const totalPages = await fetchIssued(query);
    ...
    return (
        <div className="min-h-screen flex w-full flex-col">
          ...
          <IssuedTable query={query} currentPage={currentPage} />
